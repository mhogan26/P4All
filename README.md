...
Compiler steps: parse p4all file to get info described below, determine dependencies, determine upper bounds, run ILP, use ILP solution (concrete values) to create layout or unrolled p4 program
