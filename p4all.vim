...
if !exists("p4_no_p4_14")
  ...
  syn keyword p4RegisterKeyword        Register RegisterAction Hash register width attributes
...
if !exists("p4_no_p4_16")
  ...
  syn keyword     p4allType       symbolic optimize

  " Keywords
  syn keyword     p416Statement   return exit
  syn keyword     p416Conditional if else switch
  syn keyword     p416Keyword     default const typedef
  ...
  syn keyword     p4allLoop       for
  syn keyword     p4allStmt       assume function step minimize maximize
  syn keyword     p4allFuncs      get_seed
  " Annotations
...
if version >= 508 || !exists("did_p4_syntax_inits")
  ...
  if !exists("p4_no_p4_16")
    ...
    HiLink p4allType		    Type
    HiLink p4allLoop                Keyword
    HiLink p4allStmt                Statement
    HiLink p4allFuncs	    	    Function
